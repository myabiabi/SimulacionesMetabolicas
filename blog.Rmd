...
--gem_path /workspace/modelos_core \
--strains ecoli_m9_compacto \
--cycles 5500 \
--media  m9 \
--outdir ./modelos_core/ecoli_m9_compacto_1
...
--media_dil 0.5 \
--media  m9 \
--outdir ./modelos_core/ecoli_m9_compacto_1_dil
1:22
...
--media_dil 2 \
--media  m9 \
--outdir ./modelos_core/ecoli_m9_compacto_1_dil_2
...
--media_dil 8 \
--media  m9 \
--outdir ./modelos_core/ecoli_m9_compacto_1_dil_8
...
--cycles 5500 \
--media  m9 \
--outdir ./modelos_core/ecoli_m9_compacto_glu
1:20

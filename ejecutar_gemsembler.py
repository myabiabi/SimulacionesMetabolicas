...
DATA_DIR = "/home/abigaylmontantearenas/Documents/proyecto_tesis/02_resultados/mergem/models"
OUTPUT_DIR_BASE = "/home/abigaylmontantearenas/Documents/proyecto_tesis/02_resultados/gemsembler_output"
...
def procesar_bacteria(bacteria, output_dir_base=OUTPUT_DIR_BASE):
    ...
    get_model_of_interest(supermodel, "assembly", os.path.join(output_dir, f"na_{id_bacteria}_core1.xml"))

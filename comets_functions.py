...
def media(name="lb", dil=0.1, vol=0.03):
    ...
    if name == "lb":
        res = {
         ...
         res = {
        "na1_e": 6.231041533333333 * vol * dil,
        "cl_e": 5.7273631 * vol * dil,
        "ca2_e": 0.002669793333333333 * vol * dil,
        "fe2_e": 0.001520426666666667 * vol * dil,
        "fe3_e": 0.001520426666666667 * vol * dil,
        "so4_e": 0.013013233333333333 * vol * dil,
        "pi_e": 0.14794146666666667 * vol * dil,
        "mg2_e": 0.0582322 * vol * dil,
        "k_e": 0.0859938 * vol * dil,
        "ala__L_e": 0.224482 * vol * dil,
        "asp__L_e": 0.1965896 * vol * dil,
        "asn__L_e": 0.027752766666666665 * vol * dil,
        "glu__L_e": 0.4485829 * vol * dil,
        "gln__L_e": 0.004561633333333333 * vol * dil,
        "gly_e": 0.1420953 * vol * dil,
        "his__L_e": 5.478323333333333 * vol * dil,
        "ile__L_e": 0.17787943333333334 * vol * dil,
        "leu__L_e": 0.24267836666666666 * vol * dil,
        "lys__L_e": 0.1938117 * vol * dil,
        "met__L_e": 0.05585043333333333 * vol * dil,
        "phe__L_e": 0.1311605 * vol * dil,
        "pro__L_e": 0.2200373 * vol * dil,
        "ser__L_e": 0.0951538 * vol * dil,
        "thr__L_e": 0.07275576666666666 * vol * dil,
        "trp__L_e": 0.017137633333333333 * vol * dil,
        "tyr__L_e": 0.0349539 * vol * dil,
        "val__L_e": 0.21767336666666666 * vol * dil,
        "arg__L_e": 0.12054833333333333 * vol * dil,
        "cys__L_e": 0.0110976 * vol * dil,
        "cd2_e": 2.2239222866666666E-06 * vol * dil,
        "cobalt2_e": 9.898246033333333E-06 * vol * dil,
        "cu_e": 0.00017630396 * vol * dil,
        "cu2_e": 0.00017630396 * vol * dil,
        "mn2_e": 0.00036774546 * vol * dil,
        "ni2_e": 6.925243766666667E-05 * vol * dil,
        "zn2_e": 0.0164574 * vol * dil,
        "ade_e": 0.010903066666666667 * vol * dil,
        "gua_e": 0.010201 * vol * dil,
        "csn_e": 0.006540433333333334 * vol * dil,
        "ura_e": 0.0093825 * vol * dil,
        "nh4_e": 0.07671973333333334 * vol * dil,
        "man_e": 0.0423707 * vol * dil,
        "pnto__R_e": 8.058324033333334E-05 * vol * dil,
        "btn_e": 9.190672166666667E-07 * vol * dil,
        "ascb__L_e": 2.8389734266666665E-06 * vol * dil,
        "thm_e": 6.9025726E-05 * vol * dil,
        "nac_e": 0.00054422874 * vol * dil,
        "pydx_e": 1.4777160433333333E-05 * vol * dil,
        "chol_e": 0.0005119836166666667 * vol * dil,
        "adocbl_e": 8.607545133333333E-11 * vol * dil,
        "mobd_e": 1.0233333333333333E-05 * vol * dil,
        "o2_e": 0.6066666666666667 * vol,
        "h2o_e": 1850.309927 * vol,
        "h_e": 3.3333333333333334E-06 * vol
    }
    elif name == "lb+ribose":
        res = media("lb", dil)
        res["2dr5p_e"] = 0.1 * dil
